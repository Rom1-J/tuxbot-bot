...
FIRST_SHARD_OVERRIDE = env.int("TUXBOT_FIRST_SHARD_OVERRIDE", 0)
LAST_SHARD_OVERRIDE = env.int("TUXBOT_LAST_SHARD_OVERRIDE", 0)
SHARD_COUNT_OVERRIDE = env.int("TUXBOT_SHARD_COUNT_OVERRIDE", 1)
CLUSTER_IDS = env.int("TUXBOT_CLUSTER_IDS", 0)
SHARD_IDS = env.int("TUXBOT_SHARD_IDS", 1)
