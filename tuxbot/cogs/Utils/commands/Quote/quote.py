...
class Quote:
    ...
    def __init__(
        self: typing.Self, content: str, author: str, wrap_length: int = 50
    ) -> None:
    ...
    async def generate(self: typing.Self) -> io.BytesIO:
