...
class CNF:
    ...
    def __init__(self: typing.Self, command: str) -> None:
    ...
    async def fetch(self: typing.Self) -> None:
        ...
        raise CNFException(msg)

    # =========================================================================

    def parse(self: typing.Self) -> None:
    ...
    def to_dict(self: typing.Self) -> dict[str, typing.Any]:
        """
